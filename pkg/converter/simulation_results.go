...
// DetectorResult contains simulation result data for single specs.
type DetectorResult struct {
	DetectorID       specs.DetectorID  `json:"detectorId"`
	Errors           map[string]string `json:"errors"`
...
// AddDetectorResults adds results for single specs.
